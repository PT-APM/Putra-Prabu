...
const dict: Dictionary = {
  ...
  about: {
    ...
    pimpinanPonpes: {
      heading: "Affiliated Islamic Boarding Schools",
      intro:
        "Islamic boarding schools affiliated with Yayasan Putra Prabu Indonesia Raya, guiding students and upholding Islamic outreach.",
      ...
      list: [
        ...
        },
        {
          ...
          name: "Darul Munawaroh Al-Madani Islamic Boarding School",
          location: "Sunggal, Medan, North Sumatra",
          history: "",
          address: "",
          facilities: [],
          mapsUrl: "",
          ...
          people: [
            {
              ...
              role: "Islamic Boarding School Leader",
            },
          ],
        },
      ],
