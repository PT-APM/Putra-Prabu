...
export default function ServicesPart({services} : ServicesProps){
            ...
            <Link href="/about" className="block w-full h-full">
              ...
              <div className="absolute bottom-0 left-0 p-10 w-full">
                <div className="flex items-center gap-2 mb-3 bg-white/10 w-max px-3 py-1.5 rounded-full backdrop-blur-md border border-white/20 shadow-sm">
                  ...
                  <span className="font-label-sm text-label-sm text-on-primary uppercase tracking-wider">Pendidikan Terpadu</span>
                </div>
                <h3 className="font-headline-lg text-headline-lg text-on-primary mb-3 drop-shadow-md">KB, SD, SMP, SMA</h3>
                <p className="font-body-md text-body-md text-on-primary/90 line-clamp-2 md:line-clamp-none max-w-md drop-shadow-sm">Sistem pendidikan menyeluruh yang menggabungkan keunggulan akademik dengan pembentukan karakter Islami yang kuat.</p>
              </div>
            </Link>
          </motion.div>
          ...
          <motion.div variants={fadeIn} className="relative rounded-3xl overflow-hidden group cursor-pointer border border-white/40 shadow-soft hover:shadow-soft-hover transition-all duration-500 block h-full">
            <Link href="/about" className="block w-full h-full">
              ...
              <div className="absolute bottom-0 left-0 p-8 w-full">
                ...
                <h3 className="font-headline-lg-mobile text-headline-lg-mobile text-on-primary mb-2 drop-shadow-md">Riset & Teknologi</h3>
                <p className="font-body-md text-body-md text-on-primary/90 text-sm drop-shadow-sm">Inovasi kelistrikan dan rekayasa untuk masa depan.</p>
              </div>
            </Link>
          </motion.div>
